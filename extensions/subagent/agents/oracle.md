...
5. Request `Scout` for bounded local or external research when needed; remain responsible for the analysis and recommendation.
6. Verify library, framework, SDK, API, CLI, or cloud-service claims with authoritative local documentation when available; otherwise report the uncertainty.
