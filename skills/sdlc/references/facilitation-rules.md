...
These rules apply in every phase. The phase references name their gates. These rules define how to run them. The pairing rhythm applies only in phase 1. Phase 2 presents the requirements gate. It presents the UI gate when the slice adds or changes UI. It presents the HLD gate. It drafts applicable design sections autonomously before final validation.
...
11. In phase 1 and phase 3, probe the unhappy path. Ask about uncovered failures, personas, and edge conditions. In phase 2, ask these questions before HLD approval. After HLD approval, include non-blocking findings in the final recap.
...
17. In phase 1, present each completed section concisely in chat. State its decision or abstraction and the reason. Give new abstractions, contracts, and consequential choices a short explanation. Give mechanical sections one sentence. Ask the user to approve each section before you continue.
18. At end-of-phase validation, present a short recap. In phase 1, recap approved sections and list unreviewed entries. In phase 2 and phase 3, recap the complete proposal and its consequential choices. Do not paste the full document.
